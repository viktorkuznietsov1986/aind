    ...
    def select(self):
        ...
        try:
            ...
            for cv_train_idx, cv_test_idx in split_method.split(self.sequences):
                ...
                for num_components in (self.min_n_components, self.max_n_components):
                    try:
                        model = GaussianHMM(n_components=num_components, n_iter=1000).fit(X, lengths)
